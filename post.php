<?php   
 include'db.php'; 
 $pid = @$_GET['pid'];
 $query = mysqli_query($con,"SELECT * from blog WHERE id = '$pid' ORDER BY id DESC");
  	...
  	<div class="dark-scarf">
  		...
  		<div class="mother centere">
            ...
            <div class="col-4 down-7 xs-down-20 md-down-7">
              <div class=" mother down-1"><span class="ralewayT px40 white"><?php echo $row['title'] ?> <i class="fas fa-blog"></i></span></div>
    ...
    <div class="mother down-5 xs-down-5 md-down-5">
       <div class="mother down-5">
        ...
        <div class="col-8 down-1">
          <div class="container down-1 post-container" id="pp" onclick="display0()"><span class="px13 faded"><?php echo $row['content']; ?></span>
            <div class="down-5 mother">
              ...
              <a href="" class="faded btn-sm-post bg-color-code-3"><i class="fas fa-share"></i> <span class="">0</span></a>
            </div>
          </div>
          <div class="container down-5 comments-session">
